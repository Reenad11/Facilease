...
return [
    ...
    */
    ...
    'exists' => 'حقل :attribute المحدد غير موجود فى سجلاتنا',
    ...
    */
    ...
    'attributes' => [
        "worker_ResidenceNum" => "رقم الإقامة",
        "worker_NationalID" => "الهوية الوطنية",
        "worker_Fname" => "الاسم الأول",
        "worker_Lname" => "الاسم الأخير",
        "worker_Email" => "البريد الإلكتروني",
        "worker_Phone1" => "الهاتف 1",
        "worker_Phone2" => "الهاتف 2",
        "worker_Occupation" => "المهنة",
        "worker_Skill" => "المهارة",
        "worker_Experience" => "الخبرة",
        "worker_accountNum" => "رقم الحساب",
        "worker_Iban" => "الآيبان",
        "ad_Fname" => "الاسم الأول",
        "ad_Lname" => "الاسم الأخير",
        "ad_Email" => "البريد الإلكتروني",
        "ad_Phone" => "الهاتف",
        "sch_Status" => "الحالة",
        "sch_Day" => "اليوم",
        "sch_Time_From" => "الوقت من",
        "sch_Time_To" => "الوقت إلى",
        "worker_ID" => "العامل",
